...
function personal_create_widget( $name, $id, $description ) {
...
personal_create_widget( 'Page Sidebar', 'page', 'Displays on the side of pages with a sidebar' );
personal_create_widget( 'Blog Sidebar', 'blog', 'Displays on the side of pages in the blog section' );
